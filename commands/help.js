...
module.exports = {
  ...
  callback: (message, arguments, text) => {
    ...
    const embed = new Discord.MessageEmbed() // Ver 12.2.0 of Discord.js
      ...
      .setAuthor("Canvas Notification", "https://play-lh.googleusercontent.com/2_M-EEPXb2xTMQSTZpSUefHR3TjgOCsawM3pjVG47jI-BrHoXGhKBpdEHeLElT95060B=s180", "https://github.com/leeroywking/canvas_discord_announcements")
      .addField(
        "Commands: ",
