          ...
          .then(function (response) {
            ...
            if (status === 200) {
              db.serialize(() => {
                ...
                db.run(
                  `CREATE TABLE courses (course_name TEXT, course_id INTEGER, posted_at REAL, id INTEGER, PRIMARY KEY(id AUTOINCREMENT))`,
                  (err) => {
                    if (err) {
                      console.error(err.message);
                    }
                ...
                data.forEach((element) => {
                  ...
                  db.run(
                    `INSERT INTO courses (course_name, course_id, posted_at) VALUES (` +
